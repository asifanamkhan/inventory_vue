        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header card-header-warning">
                    ...
                    <p class="card-category"> This table consist a list of category</p>
                </div>
                    ...
                    <div class="table-responsive">
                        <datatable id="dataTable" :columns="columns" :sortKey="sortKey" :sortOrders="sortOrders" @sort="sortBy" class="">
                            ...
                            <tr >
                                ...
                                <td  class="td-actions">
                                    <router-link :to="{name:'editCategory',params: { id: value.id }}"
    ...
    export default {
        ...
        data() {
            ...
            let columns = [
                ...
                {width: '', label: 'Category Name', name: 'category_name'},
